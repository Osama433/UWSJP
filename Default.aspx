...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                <h1><%: Title %></h1>
                <h2><br />Tentative Release Date: June 10th, 2014 </h2>
            </hgroup>
            <p>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <article>
         Featured
        <h1>Clouds of Uncertainty: Tackling Terror</h1>
        <br />
        <iframe width="560" height="315" src="//www.youtube.com/embed/7lkRfs7PbfE" frameborder="0" allowfullscreen></iframe>
        <br />
